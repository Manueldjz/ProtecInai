...
- (void)presentPopUpView:(UIView *)popUpView completion:(void (^)(void))completionBlock
{
    ...
    /////////////////////
    /*
    UIButton * dismissButton2 = [[UIButton alloc] init];
    dismissButton2.backgroundColor = [UIColor colorWithRed:35/255.0 green:90/255.0 blue:152/255.0 alpha:0.4];
    dismissButton2.frame = CGRectMake(43,503, 260, 47);
    
    [popUpView addSubview:dismissButton2];

    [dismissButton2 addTarget:self action:@selector(dismissPopUpViewController)
             forControlEvents:UIControlEventTouchUpInside];
